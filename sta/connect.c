...
/* Disable scanning when ATE is running. */
	...
	if (BssIdx != BSS_NOT_FOUND)
	{
		...
		NdisMoveMemory(&pAd->ScanTab.BssEntry[0], pCurrBss, sizeof(BSS_ENTRY));
		pAd->ScanTab.BssNr = 1;
	}
	...
	IN PRTMP_ADAPTER pAd) 
{
	...
	if ((pAd->CommonCfg.PhyMode >= PHY_11ABGN_MIXED) && (pAd->StaCfg.bAdhocN == TRUE))
	{
		ULONG TmpLen;
		UCHAR HtLen, HtLen1;
		HT_CAPABILITY_IE *pHtCap = &pAd->CommonCfg.HtCapability;
		ADD_HT_INFO_IE *pHtAddInfo = &pAd->CommonCfg.AddHTInfo;
#ifdef RT_BIG_ENDIAN
		HT_CAPABILITY_IE HtCapabilityTmp;
		ADD_HT_INFO_IE	addHTInfoTmp;
#endif // RT_BIG_ENDIAN //
		HT_CAPABILITY_IE local_htcap;
		...
		{
			NdisMoveMemory(&local_htcap, &pAd->CommonCfg.HtCapability, HtLen);
			local_htcap.MCSSet[1] = 0x00;
			pHtCap = &local_htcap;
		}

#ifdef RT_BIG_ENDIAN
		NdisMoveMemory(&HtCapabilityTmp, pHtCap, HtLen);
		NdisMoveMemory(&addHTInfoTmp, pHtAddInfo, HtLen1);
		*(USHORT *)(&HtCapabilityTmp.HtCapInfo) = SWAP16(*(USHORT *)(&HtCapabilityTmp.HtCapInfo));
		*(USHORT *)(&HtCapabilityTmp.ExtHtCapInfo) = SWAP16(*(USHORT *)(&HtCapabilityTmp.ExtHtCapInfo));
		*(USHORT *)(&addHTInfoTmp.AddHtInfo2) = SWAP16(*(USHORT *)(&addHTInfoTmp.AddHtInfo2));
		*(USHORT *)(&addHTInfoTmp.AddHtInfo3) = SWAP16(*(USHORT *)(&addHTInfoTmp.AddHtInfo3));
		pHtCap = &HtCapabilityTmp;
		pHtAddInfo = &addHTInfoTmp;
#endif // RT_BIG_ENDIAN //
