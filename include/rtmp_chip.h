...
/* RT3592Combo */
#define IS_RT3592CB(_pAd)	(IS_RT3572(_pAd) && ((_pAd)->NicConfig2.field.HwCoexEn == TRUE))
#define IS_WM_ON(_pAd)  WM_COEX_TEST_FLAG(_pAd, fWM_RADIO_ON)

/* RT5390 */
#define IS_RT5390(_pAd)   	((((_pAd)->MACVersion & 0xFFFF0000) == 0x53900000) || (((_pAd)->MACVersion & 0xFFFF0000) == 0x539F0000))
#define IS_RT5390CB(_pAd)	((IS_RT5390(_pAd)) && ((_pAd)->NicConfig2.field.HwCoexEn == TRUE))
...
#define VALID_EEPROM_VERSION        2 // 1
